...
[
	{
		...
		"attributes": {
			...
			"description": {
				"value": "Внимание! Перед использованием требуется обязательное <a href=\"babcom:3242342342342\">ССЫЛКА</a> ознакомление <a href=\"http://ngs.ru\">ССЫЛКА 2</a>с правилами использования, описанными в разделе 15 главы 2 Руководства (Стандартное электротехническое оборудование, том 2. — М: Наука, 2101)"
			},
			"class": {
				"name": "Класс",
				"value": 4
